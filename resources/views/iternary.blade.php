              ...
              <div class="col-12 col-md-12 col-lg-12 tablist">
                <ul class="nav nav-tabs nav-justified" role="tablist">
                    ...
                    <li class="nav-item" id="oneeside">
                        <a class="nav-link" data-toggle="tab" href="#oneWay" role="tab" aria-controls="oneWay" aria-selected="true">One Way</a>
                    </li>

                    <li class="nav-item" id="multiicities">
                        <a class="nav-link" data-toggle="tab" href="#cities" role="tab" aria-controls="cities" aria-selected="false">Multi Cities</a>
                    </li>
                ...
                <!-- Tab 2 -->
                <div class="tab-pane" id="oneWay" role="tabpanel" aria-labelledby="duck-tab">
                    2
                </div>
                <!-- tab3 -->

                <div class="tab-pane" id="cities" role="tabpanel" aria-labelledby="kiwi-tab">
                    3            
                </div>
                <!-- tab 3 end -->
