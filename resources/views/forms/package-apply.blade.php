            ...
            <div class="container px-5 py-4 mt-4" style="border: 1px solid #aaa; background-color: #eee6; border-radius: 10px;">
                <div class="row mt-4">
                    ...
                    <div class="col-12 mt-4">
                        ...
                        <form method="POST" action="{{route('store-yatri-visa')}}" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                            @csrf
                            @php
        ...
        $(document).ready(function() {
            $(document).on('change', ".total_family", function() {
                ...
                for (var i = 1; i <= total; i++) {
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 mb-2">
                        <label>City <span class="text-danger">*</span></label>
                        <input class="form-control" type="text" onkeydown="return /[a-z ]/i.test(event.key)" name="passenger_city[]"
