    ...
    <div class="page-content bg-white">
        ...
        <div class="page-banner ovbl-light" style="background-image:url({{ asset('assets/images2/Inner-banner-01.png') }});">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Payment <i class="fa fa-plane"></i></h1>
                </div>
            </div>
        </div>
        <!-- Breadcrumb row -->
        ...
        <div class="page-banner contact-page section-sp2" style="margin-top: -80px;">
            <div class="container px-5 py-4 mt-4" style="border: 1px solid #aaa; background-color: #eee6; border-radius: 10px;">
                <div class="row mt-4">
                    <div class="col-12">
                        <form method="POST" action="{{ url('all-packages/payment', $id) }}" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                            @csrf
                            <div class="col-12">
